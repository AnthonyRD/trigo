...
class Model_product extends CI_Model {
    ...
    public function get_products(){
        $this->db->select('product.id, product.name, product.description, product.charge_tax, product.image_url, product.mesurement_unit, product.reorder_level, product.entry_date, product.last_entry, supplier.name as suppier_name, product_category.name as name_category');
