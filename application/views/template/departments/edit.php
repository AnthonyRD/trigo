    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Editar Departmento</li>
      </ol>
    </section>
            ...
            <section class="col-md-12">
                <section class="box box-default">
                    <section class="box-header with-border">
                        <h3 class="box-title">Editar Departmento</h3>
                    </section>
                    <!-- /.box-header -->
                        ...
                        <section class="row">
                            <form action="confirm" method="post">
                                <section class="col-md-12">
                                    <section class="row">
                                         <section class="col-md-12">
                                              <h2 class="page-header">Información del Departmento</h2>
                                         </section>
                                    </section>
                                    <section class="row">
                                        <section class="col-md-6">
                                            ...
                                            <section class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Nombre del Departmento" value="<?=$data->name?>" required/>
                                            </section>
                                            <section class="form-group">
                                    ...
                                    <section class="row">
                                        <section class="col-md-offset-10 col-md-2">
                                            <section class="form-group">
                                                <button type="submit" class="btn btn-primary">Actualizar Departmento</button>
                                            </section>
                                        </section>
                                    </section>
                                </section>
